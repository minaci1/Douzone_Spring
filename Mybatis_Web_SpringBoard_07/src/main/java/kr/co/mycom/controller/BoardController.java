...
public class BoardController {
	...
	public String write(BoardDTO dto) {
		...
		BoardDAO boardDao = sqlsession.getMapper(BoardDAO.class); //무조건 인터페이스여야 함 
		//**************************************
	...
	public String list(Model model, String pg) {
		...
		//Mybatis >> DTO >> resultType="kr.co.mycom.model.BoardDTO" <- 매퍼의 BoardDAO 
		//10건의 데이터 DTO개 만들고 list add 주소를 return ArrayList add 자동
